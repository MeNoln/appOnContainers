...
namespace TodoListApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Data Access Context
            services.AddDbContext<TodoAccessContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            {
                scope.ServiceProvider.GetService<TodoAccessContext>().MigrateDB();
            }
        }
    }
}
